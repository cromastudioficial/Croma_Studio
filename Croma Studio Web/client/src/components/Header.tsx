    ...
    <header className="bg-white/95 shadow-md fixed w-full top-0 z-50 backdrop-blur-sm">
      <div className="flex justify-between items-center px-[5%] py-3 max-w-7xl mx-auto">
        <div className="flex items-center gap-3">
          ...
          <div className="relative h-[70px] w-[70px] rounded-full p-[2px] bg-gradient-to-r from-[#2180de] to-[#64b5f6] animate-pulse shadow-lg shadow-[#2180de]/30">
            ...
            <div className="relative h-full w-full rounded-full overflow-hidden bg-white">
              <img 
                src="https://i.postimg.cc/hPN7S5Kt/0-BC1-DA04-3-A21-4-EF5-934-E-8-CB1-F2831-EAB-4-5005-c.jpg" 
                alt="Croma Logo" 
